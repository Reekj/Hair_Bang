<template>
    <div class="w-full bg-[#F7EDE5] py-10 px-4 sm:px-6 lg:px-8">
          ...
          <div class="mt-6 flex flex-col sm:flex-row sm:items-center gap-4">
            ...
            <div class="flex items-center gap-4 flex-wrap">
              ...
              <div class="w-full sm:w-[200px] md:w-[250px] lg:w-[322px] h-14 sm:h-[70px] md:h-[85px] flex items-center justify-between border border-gray-400 rounded-full px-4 sm:px-6">
                ...
                <p class="text-xl sm:text-2xl md:text-3xl font-semibold text-center w-full">
                  {{ qty }}
                </p>
      ...
      <div class="max-w-7xl mx-auto mt-10 space-y-4">
        <button
          class="w-full h-20 sm:h-24 rounded-xl text-white text-lg sm:text-xl md:text-2xl font-medium"
          style="background: linear-gradient(90deg, #C68A2F 0%, #604317 100%)"
        >
          Buy Now
        </button>
  
        <button
          class="w-full h-20 sm:h-24 rounded-xl text-[#6A2E18] text-lg sm:text-xl md:text-2xl font-medium flex justify-center items-center gap-2"
          style="background: linear-gradient(90deg, #FFC439 0%, #997622 100%)"
        >
          <span class="text-white">Pay With</span> <span class="text-[#003087]">Paypal</span>
        </button>
      </div>
